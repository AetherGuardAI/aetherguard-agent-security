"""
AetherGuard + CrewAI Integration Example
...
# AetherGuard Proxy URL — all LLM calls route through the proxy-engine
...
# ─────────────────────────────────────────────────────────────────────────────
# CrewAI Agents (LLM calls routed through AetherGuard Proxy-Engine)
# ─────────────────────────────────────────────────────────────────────────────

# LLM instance that routes all inference through the AetherGuard secured and protected gateway.
aetherguard_llm = LLM(
    model=OPENAI_MODEL,
...
def main():
    print("=" * 70)
    print("  AetherGuard + CrewAI Integration Example")
